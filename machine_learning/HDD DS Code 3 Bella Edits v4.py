...
# Step 1: Load data from CSV files to db
...
if __name__ == "__main__":
    ...
    file_name7 = "C:\Users\Bella\.vscode\nf\groupprojectcfg\datasets\movielens\ml-latest-small\ml-latest-small\ratings.csv"
    data = Load_Data(file_name7)
...
#database creation
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///' + os.path.join(basedir, 'sqlconcat.sqlite')
